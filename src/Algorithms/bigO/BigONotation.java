...
//		BigONotation testAlgo2 = new BigONotation(1_000_000);
//		testAlgo2.generateRandomArray();
//		BigONotation testAlgo3 = new BigONotation(2_000_000);
//		testAlgo3.generateRandomArray();
//		BigONotation testAlgo4 = new BigONotation(3_000_000);
//		testAlgo4.generateRandomArray();
		BigONotation testAlgo5 = new BigONotation(10_000_000);
...
//		 testAlgo3.binarySearchForValue(20);
		...
		testAlgo5.binarySearchForValue(20);
		long endTime1 = System.nanoTime();
		System.out.println("binary search:: "+(endTime1-startTime1));
		// O (n log n) Test

		startTime = System.currentTimeMillis();
		testAlgo5.quickSort(0,testAlgo5.itemsInArray);
		endTime = System.currentTimeMillis();
		System.out.println("quickSort 3"+(endTime-startTime));
//
